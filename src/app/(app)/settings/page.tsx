      ...
      <div className="mt-8 flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-zinc-300 dark:border-zinc-700 py-24">
        <div className="mx-auto max-w-sm text-center">
          ...
          <Text className="mt-2 text-zinc-600 dark:text-zinc-400">
            Personal settings will be available in a future update. You&apos;ll be able to manage your account, notification preferences, display settings, and security options.
          </Text>
        </div>
      </div>
    </div>
